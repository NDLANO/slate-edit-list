...
import { getPreviousItem, getListForItem, isList } from '../utils';
 ...
 */
function increaseItemDepth(opts: Options, editor: Change): Change {
    const previousItem = getPreviousItem(opts, editor);
